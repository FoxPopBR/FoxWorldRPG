...
class UIScaler:
    ...
    def update_resolution(self, resolution: Tuple[int, int]):
        ...
        # Escala uniforme (menor dos dois - mantém aspect ratio)
    ...
    def get_button_rect(self, x: float, y: float, button_type: str = 'main') -> pygame.Rect:
        """
        ...
        if button_type == 'main':
            ...
            return self.rect(x, y, theme.BUTTON_SECONDARY_WIDTH, theme.BUTTON_SECONDARY_HEIGHT)
        else:  # 'small'
