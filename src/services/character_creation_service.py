...
class CharacterCreationService:
    ...
    def calculate_final_attributes(self, base_attributes: Dict[str, int], class_data: Dict[str, Any]) -> Dict[str, int]:
    ...
    def calculate_derived_attributes(self, base_attributes: Dict[str, int], class_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        derived = {
            # Atributos básicos
            'vida_maxima': effective_attrs['vitalidade'] * 12 + effective_attrs['forca'] * 3,
            'mana_maxima': effective_attrs['inteligencia'] * 10 + effective_attrs['energia'] * 5,
            'dano_fisico_min': effective_attrs['forca'] * 2,
            'dano_fisico_max': effective_attrs['forca'] * 3 + effective_attrs['destreza'],
            'dano_magico_min': effective_attrs['inteligencia'] * 2,
            'dano_magico_max': effective_attrs['inteligencia'] * 3,
            'defesa_fisica': effective_attrs['armadura'] * 3 + effective_attrs['vitalidade'] // 2,
            'defesa_magica': effective_attrs['inteligencia'] * 2 + effective_attrs['energia'],
            ...
            'capacidade_carga': effective_attrs['forca'] * 10 + effective_attrs['vitalidade'] * 5
        }
    ...
    def create_character(self, name: str, class_key: str, base_attributes: Dict[str, int]) -> Optional[Dict[str, Any]]:
        ...
        final_attributes = self.calculate_derived_attributes(base_attributes, class_data)
