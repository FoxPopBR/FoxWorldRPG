...
class GameState(BaseState):
    ...
    def _render_load_menu(self, surface):
        ...
        # Caixa do menu
        menu_rect = pygame.Rect(1920 // 2 - 250, 300, 500, 450)
        ...
        surface.blit(title_text, (1920 // 2 - title_text.get_width() // 2, 320))
    ...
    def _render_save_menu(self, surface):
        ...
        # Caixa do menu
        menu_rect = pygame.Rect(1920 // 2 - 250, 300, 500, 400)
        pygame.draw.rect(surface, (30, 30, 40), menu_rect, border_radius=15)
        ...
        surface.blit(title_text, (1920 // 2 - title_text.get_width() // 2, 330))

        # Subtítulo
        sub_font = self.game.game_config.get_font("menu", 20)
        sub_text = sub_font.render(
            "Escolha um slot para sobrescrever", True, (200, 200, 200)
        )
        surface.blit(sub_text, (1920 // 2 - sub_text.get_width() // 2, 380))
    ...
    def _render_menu_overlay(self, surface):
        ...
        # Caixa do menu
        menu_rect = pygame.Rect(1920 // 2 - 200, 290, 400, 500)
        pygame.draw.rect(surface, (30, 30, 40), menu_rect, border_radius=15)
    ...
    def _render_sidebar(self, surface):
        ...
        # Fundo do sidebar
        sidebar_rect = pygame.Rect(5, 115, 90, 455)  # 5 botões * 85px (70 + 15)
    ...
    def _render_game_area(self, surface, screen_width, game_area_height):
        ...
        dev_font = self.game.game_config.get_font("menu", 28)
    ...
    def _render_hud_phantasy_star(
        ...
        self._render_hud_section_name(surface, 20, hud_y + 20, section_width - 40)
        ...
        self._render_hud_section_vitals(
            surface, section_width + 20, hud_y + 20, section_width - 40
        )
        ...
        self._render_hud_section_level(
            surface, section_width * 2 + 20, hud_y + 20, section_width - 40
        )
        ...
        self._render_hud_section_extras(
            surface, section_width * 3 + 20, hud_y + 20, section_width - 40
        )

    def _render_hud_section_name(self, surface, x, y, width):
        ...
        surface.blit(class_text, (x, y + 45))

        # Ícone ou sprite do personagem
        icon_rect = pygame.Rect(x, y + 80, 80, 80)

        # Fundo do ícone
        pygame.draw.rect(surface, (20, 20, 30), icon_rect, border_radius=8)

        if self.hero.image_face:
            # Escala a imagem para caber no box (80x80)
            face_img = pygame.transform.scale(self.hero.image_face, (80, 80))
    ...
    def _render_hud_section_vitals(self, surface, x, y, width):
        """Renderiza seção de HP e MP com barras"""
        label_font = self.game.game_config.get_font("menu", 20)
        value_font = self.game.game_config.get_font("title", 24)
        ...
        pygame.draw.rect(
            surface, hp_color, (bar_x, bar_y, filled_width, bar_height), border_radius=5
        )
        ...
        surface.blit(mp_text, (x + 50, y + 67))
    ...
    def _render_hud_section_level(self, surface, x, y, width):
        """Renderiza seção de nível e experiência"""
        label_font = self.game.game_config.get_font("menu", 20)
        value_font = self.game.game_config.get_font("title", 32)
        ...
        surface.blit(level_text, (x, y + 30))

        # Experiência
        exp_label = label_font.render("EXP", True, (200, 200, 200))
        surface.blit(exp_label, (x, y + 85))

        exp_font = self.game.game_config.get_font("menu", 22)
        exp_text = exp_font.render(str(self.hero.experience), True, (200, 255, 200))
        surface.blit(exp_text, (x, y + 115))

    def _render_hud_section_extras(self, surface, x, y, width):
        ...
        surface.blit(gold_text, (x, y + 30))

        # Localização
        loc_label = label_font.render("ZONA", True, (200, 200, 200))
        surface.blit(loc_label, (x, y + 85))

        loc_font = self.game.game_config.get_font("menu", 22)
        loc_text = loc_font.render(f"Zona {self.hero.zone_id}", True, (150, 200, 255))
        surface.blit(loc_text, (x, y + 115))
    ...
    def render(self, surface):
        ...
        # 1. Renderiza área do jogo (mundo)
        # Altura disponível para o jogo = Altura total - HUD
        game_area_height = screen_height - 200
